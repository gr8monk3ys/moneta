...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: font.display, color: theme.textPrimary, fontSize: 26, fontWeight: '700', marginBottom: 8 },
  plan: { color: theme.textMuted, marginBottom: 4 },
  subtitle: { color: theme.textMuted },
  error: { color: theme.danger },
  success: { color: theme.success },
  paywall: { ...surface.cardElevated, borderColor: theme.accent, padding: 16, gap: 8 },
  paywallTitle: { fontFamily: font.display, color: theme.textPrimary, fontSize: 17, fontWeight: '700' },
  paywallBody: { color: theme.textSecondary, lineHeight: 20 },
  ...
  paywallButton: surface.buttonPrimary,
  paywallButtonText: { color: theme.onAccent, textAlign: 'center', fontWeight: '700' },
  ...
  sectionHeader: { marginTop: 18, marginBottom: 10, gap: 4 },
  sectionEyebrow: { color: theme.accent, fontSize: 12, fontWeight: '700', letterSpacing: 1.4, textTransform: 'uppercase' },
  sectionTitle: { fontFamily: font.display, color: theme.textPrimary, fontSize: 19, fontWeight: '700' },
  sectionDescription: { color: theme.textMuted, lineHeight: 19 },
  node: { ...surface.card, padding: 14, marginBottom: 8 },
  activeNode: { borderColor: theme.accent, backgroundColor: theme.accentSoft },
  completedNode: { borderColor: theme.success },
  lockedNode: { opacity: 0.65 },
  nodeTopRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 10 },
  nodeText: { color: theme.textPrimary, fontWeight: '600', flexShrink: 1 },
  nodeMeta: { color: theme.textMuted, marginTop: 4, fontSize: 12 },
  activeNodeText: { color: theme.accentBright },
  lockedNodeText: { color: theme.textMuted },
  pill: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4, backgroundColor: 'rgba(154, 176, 170, 0.14)' },
  pillText: { color: theme.textMuted, fontSize: 11, fontWeight: '700' },
  activePill: { backgroundColor: theme.accentSoft },
  activePillText: { color: theme.accentBright },
  completedPill: { backgroundColor: theme.successSoft },
  completedPillText: { color: theme.success },
  lockedPill: { backgroundColor: 'rgba(154, 176, 170, 0.14)' },
